(function() {
  var Git, Multispinner, async, bower, downloadDependencies, fs, gitRepository, home, os, path, prettyjson, template_dir, template_git_dir, template_git_pwd, template_pwd;
